...
const STRINGS: Record<Lang, Strings> = {
  fr: {
    ...
    spacesAll: 'Tous les espaces',
    spaceDefault: 'Personnel',
    spaceNew: 'Nouvel espace…',
    spaceNamePlaceholder: 'Pro, Projet X…',
    spaceCreate: 'Créer',
    spaceRename: 'Renommer',
    spaceDelete: 'Supprimer',
    spaceDeleteConfirm: 'Ses notes retournent dans Personnel.',
    spaceLabel: 'Espace',
  ...
  en: {
    ...
    spacesAll: 'All spaces',
    spaceDefault: 'Personal',
    spaceNew: 'New space…',
    spaceNamePlaceholder: 'Work, Project X…',
    spaceCreate: 'Create',
    spaceRename: 'Rename',
    spaceDelete: 'Delete',
    spaceDeleteConfirm: 'Its notes go back to Personal.',
    spaceLabel: 'Space',
